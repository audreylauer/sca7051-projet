...
# lire data
with open(exp+'15-data.csv', newline='') as csvfile:
...
with open(exp+'25-data.csv', newline='') as csvfile:
    spamreader = csv.reader(csvfile)
    i = 0
    for temp in spamreader:
        row = []
...
with open(exp+'05-data.csv', newline='') as csvfile:
    spamreader = csv.reader(csvfile)
    i = 0
    for temp in spamreader:
        row = []
