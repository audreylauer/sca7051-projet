...
# lire data
with open(exp+'1-data.csv', newline='') as csvfile:
...
with open(exp+'2-data.csv', newline='') as csvfile:
    spamreader = csv.reader(csvfile)
    i = 0
    for temp in spamreader:
        row = []
...
with open(exp+'60-data.csv', newline='') as csvfile:
    spamreader = csv.reader(csvfile)
    i = 0
    for temp in spamreader:
        row = []
...
plt.legend(['1 sec', '2 sec', '10 sec', '60 sec'])
