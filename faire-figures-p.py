...
# lire data
with open(exp+'1000-data.csv', newline='') as csvfile:
...
with open(exp+'900-data.csv', newline='') as csvfile:
    spamreader = csv.reader(csvfile)
    i = 0
    for temp in spamreader:
        row = []
...
with open(exp+'700-data.csv', newline='') as csvfile:
    spamreader = csv.reader(csvfile)
    i = 0
    for temp in spamreader:
        row = []
...
with open(exp+'500-data.csv', newline='') as csvfile:
    spamreader = csv.reader(csvfile)
    i = 0
    for temp in spamreader:
        row = []
...
plt.legend(['1000 hPa', '900 hPa', '700 hPa', '500 hPa'])
