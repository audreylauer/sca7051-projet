...
# lire data
with open(exp+'250-data.csv', newline='') as csvfile:
...
with open(exp+'100-data.csv', newline='') as csvfile:
    spamreader = csv.reader(csvfile)
    i = 0
    for temp in spamreader:
        row = []
...
with open(exp+'200-data.csv', newline='') as csvfile:
    spamreader = csv.reader(csvfile)
    i = 0
    for temp in spamreader:
        row = []
...
plt.legend(['250 m', '100 m', '200 m', '500 m'])
